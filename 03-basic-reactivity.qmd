...
Compare this failed experiment wit the correct solution in @lst-print-reactive-context. 
...
In the case above we didn't use the additional node, to simplify the code. In order to understand why we need `r glossary("reactivce epxressions")` we need a more complex example. Hadley offers in the book the comparison of two simulated datasets with a plot and a hypothesis test. 
