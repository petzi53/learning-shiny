...
- @sec-chap17 introduces you to the big ideas of software engineering.
- @sec-chap18 shows you how to extract code out of your Shiny app into independent apps, and discuss why you might want to do so.
- @sec-chap19 teaches you about Shiny’s module system, which allows you to extract coupled UI and server code into isolated and reusable components.
