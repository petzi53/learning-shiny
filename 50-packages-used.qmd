# Packages used {#sec-annex-packages-used}

::: {.callout-important}
###### Shiny specific packages are marked

Packages that are essential for the usage of Shiny are marked orange in their header. The other packages are mentioned throughout the book, but ore either of general use (like the {**tidyverse**} collection) or for specific parts of this book (e.g., exercises).
:::

## ambient {#sec-annex-ambient}
...
<center>[A Generator of Multidimensional Noise](https://ambient.data-imaginist.com) [@ambient]</center>

------------------------------------------------------------------------

::: {layout="[10, 30]" layout-valign="center"}
![](img/logoi/logo-ambient-min.png){width="176"}
...
:::: my-packagebox-container
<center>[Call R from R](https://callr.r-lib.org) [@callr]</center>

------------------------------------------------------------------------

<center>(There is no hexagon sticker available for {**callr**}.)</center>
...
::: {layout="[10, 30]" layout-valign="center"}
![](img/logoi/logo-janitor-min.png){width="176"}
...
:::: my-packagebox-container
<center>[Terminal Progress Bars](https://r-lib.github.io/progress/) [@progress]</center>

------------------------------------------------------------------------


::: {layout="[10, 30]" layout-valign="center"}
![](img/logoi/logo-progress-min.png){width="176"}
...
## [reactlog]{.mark} {#sec-annex-reactlog}
...
## [shinycssloaders]{.mark} {#sec-annex-shinycssloaders}
...
:::: my-packagebox-container
<center>[Add Loading Animations to a 'shiny' Output While It's Recalculating](https://github.com/daattali/shinycssloaders) [@shinycssloaders]</center>

------------------------------------------------------------------------

<center>(There is no hexagon sticker available for {**shinycssloaders**}.)</center>
...
## [shinydashboard]{.mark} {#sec-annex-shinydashboard}
...
## [shinyFeedback]{.mark} {#sec-annex-shinyFeedback}
...
## [shinylive]{.mark} {#sec-annex-shinylive}
...
## [shinymaterial]{.mark} {#sec-annex-shinymaterial}
...
## [shinymeta]{.mark} {#sec-annex-shinymeta}
...
:::: my-packagebox-container
<center>[Export Domain Logic from Shiny using Meta-Programming](	https://rstudio.github.io/shinymeta/) [@shinymeta]</center>

------------------------------------------------------------------------

<center>(There is no hexagon sticker available for {**shinymeta**}.)</center>
...
::: {.callout-note}
Learn more about the {**shinymeta**} package in Joe Cheng’s useR! 2019 keynote, “[Shiny’s holy grail](https://www.youtube.com/watch?v=5KByRC6eqC8)^[Attention: The video starts at minute 11:20.]: Interactivity with reproducibility”. The code for the example Shiny app is available at GitHub. The sample code is useful in its own. It features package download data from `r glossary("CRAN")`.

Keep in mind that there were [breaking changes](https://github.com/rstudio/shinymeta/wiki/Syntax-changes-for-shinymeta-0.2.0) in the meantime by replacing bang-bang (`!!`) with the dot-dot operator (`..()`). 
:::
...
## [shinyMobile]{.mark} {#sec-annex-shinyMobile}
...
## [shinysnippets]{.mark} {#sec-annex-shinysnippets}
...
::: {.callout-note}
###### {shinysnippets} is not useful for me

I have my own Shiny snippets mostly for the markdown text (callout boxes with code snippets) but also for R scripts. My system is much more sophisticated. Instead of using the {**shinysnippets**} package I will use my own system and add those snippets from {**shinysnippets**} that are valuable for me.
...
## [shinyvalidate]{.mark} {#sec-annex-shinyvalidate}
...
## [shiny.semantic]{.mark} {#sec-annex-shiny.semantic}
...
::: {layout="[10, 30]" layout-valign="center"}
![](img/logoi/logo-withr-min.png){width="176"}
