...
I have therefore only the app source code provided. To run the app, copy it form the code chunks below or fork this repo and run the provided app.
...
```{r}
#| label: real-time-shiny-themes-updates
#| eval: false
