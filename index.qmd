...
This books collects my personal notes during reading [Mastering Shiny](https://mastering-shiny.org/index.html) by Hadley Wickham [@wickham2021].

::: {.callout-note style="color: blue;"}
#### This is work in progress

I have finished about 77% of the book content. Currently I am working on @sec-chap19.

From the text already covered are following exercises still missing:
 
- @sec-04-exercises 4.8: all four
...
- @sec-14-exercises 14.4.5 the second and third
- @sec-16-exercises 16.3.4 all three
:::
