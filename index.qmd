...
I have finished about 48%. Currently I am working on the exercises for @sec-chap09.

@sec-chap04_8_exercises 4.8 and @sec-chap06-5_4_exercises 6.5.4 are missing.

:::

:::::{.my-watch}
:::{.my-watch-header}
WATCH OUT: This is neither an accurate replication nor an authoritative textbook.
:::
::::{.my-watch-container}
...
[Mastering Shiny](https://mastering-shiny.org/) by Hadley Wickham [@wickham2021].

I am learning wot work with {**shiny**} because I want to develop a dashboard for investigating countries in world maps with values of different years. For instance I want to use the `r glossary("WHR")` data 2011, 2012, 2014-2024 and show the distributions of the ladder scores abount the countries of the world.
...
My text consists mostly of quotes from the [Mastering Shiny book](https://www.amazon.de/Mastering-Shiny-Interactive-Reports-Dashboards/dp/1492047384/). Sometimes I have them changed slightly to adapt it to the flow of my notes. But I have not shown that it is a quote nor I jave referenced the position of the (semi)quotes in the book. As I am generally follow the book's outline using the same text for headers, it should be clear where to find the quotes. 
...
I am using the {**glossary**} package [@glossary] to create links to glossary
entries.
...
an window with the appropriate glossary text. Try this example: `r glossary("WHR")`.
...
If you fork [my repository of these notes](https://github.com/petzi53/learning-shiny) then the glossary will not
...
During coding I am following the [Tidyverse Style Guide](https://style.tidyverse.org/). For learning purposes I am practicing {**shiny**} in two modes:

1. **{shiny} app**: I am writing the code in extra `app.R` files as explained in the book. I create folders with the number of the chapters, eg., `apps-01`, `apps-02`. Inside of these chapter folders I put the folders for the {**shiny**} examples with self explanatory names so that one can get and distinguish the example files that all have the name `app.R`. Additionally I order these examples with numbers that represents their appearance in the text, e.g., `01-hello-world`, `02-greetings1` `03-greetings2`, etc. 
...
::: {.callout-caution}
I am not using always the exact code snippets of the book,
...
- Wickham, H. (2021). Mastering Shiny: Build Interactive Apps, Reports, and Dashboards Powered by R. O’Reilly UK Ltd.
- [Online version of Mastering Shiny](https://mastering-shiny.org/index.html)
- [Mastering Shiny Solutions](https://mastering-shiny-solutions.org/index.html)
- [shiny cheatsheet](https://rstudio.github.io/cheatsheets/shiny.pdf)
- [shiny docs & tutorial](https://shiny.posit.co/)
- [shinylive-r in Quarto](https://quarto.thecoatlessprofessor.com/r-shinylive-demo/)
