...
`reactiveVal()`. We’ll come back to `reactiveVal()` in @sec-chap16, but I
wanted to show it here because it’s such a useful technique. You’ll
probably need to re-read this section after you’ve read @sec-chap16, but
...
the challenges we’ll come back to later in @sec-chap16.
