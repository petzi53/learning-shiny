...
randomUI <- function(id) {
    tagList(
        fluidRow(
            column(1, actionButton(NS(id, "go0"), "Go-0!")),
            column(1, textOutput(NS(id, "val0")))
        ),
        fluidRow(
            column(1, actionButton(NS(id, "go1"), "Go-1!")),
            column(1, textOutput(NS(id, "val1")))
        ),
        fluidRow(
            column(1, actionButton(NS(id, "go2"), "Go-2!")),
            column(1, textOutput(NS(id, "val2")))
        ),
        fluidRow(
            column(1, actionButton(NS(id, "go3"), "Go-3!")),
            column(1, textOutput(NS(id, "val3")))
        )
    )
}
