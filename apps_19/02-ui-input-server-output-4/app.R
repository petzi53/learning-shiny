## NOT FINISHED - ONLY TEMPLATE
## path: apps_19/02-ui-input-server-output-4/app.R
...
## Another extension: MODULE INSIDE MODULE
## idea comes from 19.3.4 "Module inside Modules"
